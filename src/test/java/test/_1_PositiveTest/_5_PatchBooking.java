...
public class _5_PatchBooking {
    ...
    public void setupData() throws JsonProcessingException {
        ...
        bookingPayload.setFirstname("Semih");
        bookingPayload.setLastname("Çat");

        response = BookingEndPoints.updatePatchBooking(_2_CreateBooking.bookingid, bookingPayload);
